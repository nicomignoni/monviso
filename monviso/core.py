...
class VI:
    ...
    def __init__(self, F, g=0, S=[], n=None) -> None:
    ...
    def graal(self, 
        ...
        """
        while True:
            y = ((GOLDEN_RATIO - 1)*x + y)/GOLDEN_RATIO
    ...
    def hgraal_1(self, 
        ...
        J = lambda x: np.linalg.norm(x - self.prox(x - self.F(x)))
        J_min = np.inf
        ...
        while True:
            ...
            J_current, J_previous = J(x_current), J(x_previous)
